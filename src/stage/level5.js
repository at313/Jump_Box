var level5_Scene =  cc.Scene.extend({
  onEnter: function(){
    this._super();
    size = cc.director.getWinSize();
    set_World(this);
    stage_layer[4] = new level5Layer();
    this.addChild(stage_layer[4]);
    this.scheduleUpdate();
  },
...
var level5Layer = cc.Layer.extend({
  ctor: function(){
    ...
    var level_label = cc.LabelTTF.create("level:5", "Arial", 25);
    ...
    */
    ...
    var a = new Enemy1(this, 230, 150);
    var b = new Enemy2(this, 570, 300);
    var c = new Block_EL(this, 330, 300, 80, 80, 3, 3);
    ...
    var map = new Tiledmap(this, res.lv5_tmx);
    },
    block_ban: function(){
    ...
    game_over: function(){
      ...
      cc.director.runScene(cc.TransitionFade.create(1, new OverScene(new level5_Scene())));
      return true;
    },
