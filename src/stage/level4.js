var level4_Scene =  cc.Scene.extend({
  onEnter: function(){
    this._super();
    size = cc.director.getWinSize();
    set_World(this);
    stage_layer[3] = new level4Layer();
    this.addChild(stage_layer[3]);
    this.scheduleUpdate();
  },
...
var level4Layer = cc.Layer.extend({
  ctor: function(){
    ...
    var level_label = cc.LabelTTF.create("level:4", "Arial", 25);
    ...
    */
    ...
    var a = new Enemy1(this, 300, 150);
    var b = new Enemy2(this, 600, 300);
    ...
    var map = new Tiledmap(this, res.lv4_tmx);
    },
    block_ban: function(){
    ...
    game_over: function(){
      ...
      cc.director.runScene(cc.TransitionFade.create(1, new OverScene(new level4_Scene())));
      return true;
    },
