var level3_Scene =  cc.Scene.extend({
  onEnter: function(){
    this._super();
    size = cc.director.getWinSize();
    set_World(this);
    stage_layer[2] = new level3Layer();
    this.addChild(stage_layer[2]);
    this.scheduleUpdate();
  },
...
var level3Layer = cc.Layer.extend({
  ctor: function(){
    ...
    var level_label = cc.LabelTTF.create("level:3", "Arial", 25);
    ...
    var a = new Block_EL(this, 250, 200, 50, 50, 2, 2);
    var b = new Block_EL(this, 420, 250, 50, 50, 3, 3);
    ...
    var map = new Tiledmap(this, res.lv3_tmx);
    },
    block_ban: function(){
    ...
    game_over: function(){
      ...
      cc.director.runScene(cc.TransitionFade.create(1, new OverScene(new level3_Scene())));
      return true;
    },
